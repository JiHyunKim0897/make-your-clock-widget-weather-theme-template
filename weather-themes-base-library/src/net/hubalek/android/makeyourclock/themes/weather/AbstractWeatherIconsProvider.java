package net.hubalek.android.makeyourclock.themes.weather;
...
import static net.hubalek.android.makeyourclock.themes.weather.Constants.*;
/**
 * Providers weather icons.
 */
public abstract class AbstractWeatherIconsProvider extends ContentProvider {
    ...
    public AssetFileDescriptor openAssetFile(Uri uri, String mode) throws FileNotFoundException {
        ...
        Log.d(Constants.LOG_TAG, "AbstractWeatherIconsProvider.openAssetFile(" + uri + "," + mode + " called...");
        ...
        if (uri.getPathSegments().size() > 1 && uri.getPathSegments().get(0).equals(CONTENT_PROVIDER_PATH_ELEMENT_ICONS)) {
            ...
            if (icon_name.equals(CONTENT_PROVIDER_PATH_ELEMENT_SAMPLE_ICON)) {
                icon_name = DEFAULT_SAMPLE_ICON_NAME;
            }
